...
###############################################################################
#                                                                             #
# Create a function is_ordered that receives a sequence and returns True if   #
# the elements are in sorted order. Test your function with sorted and        #
# unsorted lists, tuples and strings.                                         #
#                                                                             #
###############################################################################
